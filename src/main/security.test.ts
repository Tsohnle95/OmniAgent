...
describe("renderer navigation policy", () => {
  it("always selects the packaged file and ignores renderer environment overrides", () => {
    const packaged = "file:///Applications/OpenShell.app/Contents/Resources/app/out/renderer/index.html";
  ...
  it("allows the exact packaged document but denies other main-frame navigations and redirects", () => {
    const trusted = trustedApplicationLocation("file:///Applications/OpenShell.app/Contents/Resources/app/out/renderer/index.html");

    expect(isAllowedMainFrameNavigation("file:///Applications/OpenShell.app/Contents/Resources/app/out/renderer/index.html", true, trusted)).toBe(true);
    expect(isAllowedMainFrameNavigation("file:///Applications/OpenShell.app/Contents/Resources/app/out/renderer/other.html", true, trusted)).toBe(false);
