...
describe("renderer navigation policy", () => {
  it("allows the exact packaged document but denies other main-frame navigations and redirects", () => {
    ...
    expect(isAllowedMainFrameNavigation("file:///Applications/OpenShell/resources/app/out/renderer/index.html", true, trusted)).toBe(true);
    expect(isAllowedMainFrameNavigation("file:///Applications/OpenShell/resources/app/out/renderer/other.html", true, trusted)).toBe(false);
