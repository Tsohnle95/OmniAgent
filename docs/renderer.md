...
- **Runtime-neutral transcript presentation** — `OpenCodeTimeline.tsx` retains
  ...
  disclosure whose one-line summary follows the latest live reasoning line and
  is rendered in full only when the user expands it; the generic
