...
| `EditorPane` | `EditorPane.tsx` | Tab bar (dirty dot, ⇄ diff badge), Monaco `Editor`/`DiffEditor` with add/remove overview markers beside the scrollbar, Edit/Diff + Wrap toolbar, ⌘S save, 4 MiB/binary guards |
