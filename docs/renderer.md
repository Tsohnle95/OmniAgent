...
| `SettingsSidebar` | `SettingsSidebar.tsx` | Replaces Sessions/Files while Settings is open and provides dedicated navigation for Appearance, Plugins, Providers, Safety, Voice, Model, Mobile Setup, and bottom-separated About; its footer cog occupies the same fixed slot and returns to the workspace |
