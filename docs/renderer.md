...
line immediately above the composer. It deliberately avoids repeating the
timeline: the line shows only a restrained theme-accent shimmer labeled
`Thinking` during native reasoning or `Working` for every other active phase.
The dock remains
